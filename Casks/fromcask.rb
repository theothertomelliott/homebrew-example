cask "fromcask" do
  ...
  on_intel do
    ...
    binary "homebrew-example-darwin-amd64/homebrew-example", target: "homebrew-example"
  end
  ...
  on_arm do
    ...
    binary "homebrew-example-darwin-arm64/homebrew-example", target: "homebrew-example"
  end
end
